...
const ClaimReport = () => {
  ...
  const columnDefs = [
    ...
    { headerName: 'Mortgage Loan Number', field: 'Mortgage Loan Number', filter: true, floatingFilter: true },
    { headerName: 'Elevated Bldg', field: 'Elevated Bldg', filter: true, floatingFilter: true },
