...
const DataFetchFilterComponent = () => {
  ...
  const [totalWrittenPremium, setTotalWrittenPremium] = useState(0);
        ...
        <div style={styles.mainContent}>
          <div style={styles.cardsContainer}>
            <Card
              ...
              content={formatNumber(totalPolicies)}
              style={styles.cardStyle}
            />
            <Card
              title="Total Written Premium"
              content={`$${formatNumber(totalWrittenPremium)}`}
              style={styles.cardStyle}
            />
             <Card
              title="Total Written Premium"
...
export default DataFetchFilterComponent;
